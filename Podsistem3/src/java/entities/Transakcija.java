...
public class Transakcija implements Serializable {
    ...
    @JoinColumn(name = "id_filijale", referencedColumnName = "id")
    @ManyToOne(optional = false)
    private Filijala idFilijale;
    ...
    public Transakcija(Integer id, String tip, Date datumVreme, double iznos, int redniBroj, String svrha) {
        this.id = id;
        this.tip = tip;
    ...
    public Filijala getIdFilijale() {
        return idFilijale;
    }

    public void setIdFilijale(Filijala idFilijale) {
